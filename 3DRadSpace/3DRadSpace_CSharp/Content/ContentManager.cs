...
{
    [DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ContentManager_Load")]
    unsafe static extern IntPtr _load(IntPtr content, Reflection.UUID* uuid, string path, uint* id);

    [DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ContentManager_Reload")]
    static extern void _reload(IntPtr content, uint id);

    [DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ContentManager_Remove")]
    static extern void _remove(IntPtr content, uint id);

    [DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ContentManager_Clear")]
