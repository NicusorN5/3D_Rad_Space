...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OBox_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OBox_GetColor")]
		extern static Color _getColor(IntPtr box);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OBox_SetColor")]
