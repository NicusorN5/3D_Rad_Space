...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_GetFogBegin")]
		extern static float _getFogBegin(IntPtr fog);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_SetFogBegin")]
		extern static void _setFogBegin(IntPtr fog, float fogBegin);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_GetFogEnd")]
		extern static float _getFogEnd(IntPtr fog);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_SetFogEnd")]
		extern static void _setFogEnd(IntPtr fog, float fogBegin);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_GetFogColor")]
		extern static Color _getFogColor(IntPtr fog);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Fog_SetFogColor")]
