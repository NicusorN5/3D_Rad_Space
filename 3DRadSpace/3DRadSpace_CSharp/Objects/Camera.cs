...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_GetNormal")]
		extern static Vector3 _getNormal(IntPtr camera);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetNormal")]
		extern static unsafe void _setNormal(IntPtr camera, Vector3* normal);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_GetAspectRatio")]
		extern static float _getAspectRatio(IntPtr camera);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetAspectRatio")]
		extern static void _setAspectRatio(IntPtr camera, float aspectRatio);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_GetFOV")]
		extern static float _getFOV(IntPtr camera);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetFOV")]
		extern static void _setFOV(IntPtr camera, float fov);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_GetNPD")]
		extern static float _getNPD(IntPtr camera);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetNPD")]
		extern static void _setNPD(IntPtr camera, float npd);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_GetFPD")]
		extern static float _getFPD(IntPtr camera);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetFPD")]
		extern static void _setFPD(IntPtr camera, float fpd);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Camera_SetLookAt")]
