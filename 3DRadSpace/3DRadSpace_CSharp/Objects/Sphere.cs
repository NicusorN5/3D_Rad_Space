...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_GetColor")]
		extern static Color _getColor(IntPtr sphere);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_SetColor")]
		extern static unsafe void _setColor(IntPtr sphere, Color* color);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_GetRadius")]
		extern static float _getRadius(IntPtr sphere);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_SetRadius")]
		extern static void _setRadius(IntPtr sphere, float radius);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_GetResolution")]
		extern static uint _getResolution(IntPtr sphere);

		[DllImport("3DRadSpace.Objects.dll", EntryPoint = "E3DRSP_OSphere_SetResolution")]
