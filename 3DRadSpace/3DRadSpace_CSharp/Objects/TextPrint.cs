...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_TextPrint_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_TextPrint_GetFontID")]
		extern static uint _getFontID(IntPtr textPrint);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_TextPrint_SetFontID")]
		extern static void _setFontID(IntPtr textPrint, uint id);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_TextPrint_GetColor")]
		extern static Color _getColor(IntPtr textPrint);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_TextPrint_SetColor")]
