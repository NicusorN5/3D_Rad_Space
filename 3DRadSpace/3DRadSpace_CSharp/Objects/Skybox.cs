...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Skybox_Create")]
		extern static IntPtr _create();

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Skybox_Get")]
		extern static uint _getSkyboxID(IntPtr skinmesh);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_Skybox_Set")]
