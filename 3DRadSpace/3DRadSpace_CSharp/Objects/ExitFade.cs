...
namespace Engine3DRadSpace.Objects
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ExitFade_Create")]
		...
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ExitFade_GetFadeColor")]
		extern static Color _getColor(IntPtr exitFade);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ExitFade_SetFadeColor")]
		extern static unsafe void _setColor(IntPtr exitFade, Color* color);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ExitFade_GetFadeTime")]
