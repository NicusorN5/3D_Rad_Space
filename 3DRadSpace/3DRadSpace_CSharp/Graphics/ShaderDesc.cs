...
{
	[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ShaderDesc_Destroy")]
	extern static void _destroy(IntPtr desc);

	[DllImport("3DRadSpace.FFI.dll", CharSet = CharSet.Ansi, EntryPoint = "E3DRSP_ShaderDesc_CreateFromFile")]
	extern static IntPtr _createFile(string path, string entry, ShaderType type, ShaderFeatureLevel featureLevel);

	[DllImport("3DRadSpace.FFI.dll", CharSet = CharSet.Ansi, EntryPoint = "E3DRSP_ShaderDesc_CreateFromSource")]
