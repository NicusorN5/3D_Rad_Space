...
namespace Engine3DRadSpace.Graphics
{
	...
	{
		[DllImport("3DRadSpace.Graphics.dll", EntryPoint = "E3DRSP_IGPUMultiBuffer_ReadData")]
		extern static ulong _readData(IntPtr res, ulong subresource, IntPtr ppData);

		[DllImport("3DRadSpace.Graphics.dll", EntryPoint = "E3DRSP_IGPUMultiBuffer_SetData")]
		extern static void _writeData(IntPtr res, ulong subresource, IntPtr pData, ulong dataSize);

		[DllImport("3DRadSpace.Graphics.dll", EntryPoint = "E3DRSP_IGPUMultiBuffer_EndRead")]
