...
namespace Engine3DRadSpace.Graphics
{
	...
	{
		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ITexture1D_Size")]
		extern static long _size(IntPtr texture);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ITexture1D_GetViewHandle")]
		extern static IntPtr _viewHandle(IntPtr texture);

		[DllImport("3DRadSpace.FFI.dll", EntryPoint = "E3DRSP_ITexture1D_CreateStaging")]
