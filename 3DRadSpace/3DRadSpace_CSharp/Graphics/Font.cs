...
namespace Engine3DRadSpace.Graphics
{
    public class Font : NatPtrWrapper
    {
        ...
        {
            get { return _supportedCharacters(_handle); }
        }
        ...
        public ITexture2D Texture
        {
            get
            {
                return new InstITexture2D(_texture(_handle));
            }
        }
        ...
        unsafe Glyph? _getGliph(char chr)
        {
            ...
            if (pGlyph == IntPtr.Zero) return null;
        ...
        unsafe Internal.Rectangle? _getSrcRectangle(char chr)
        {
            ...
            if (pRect == IntPtr.Zero) return null;
